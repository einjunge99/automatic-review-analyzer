...
def check_perceptron():
    ...
    # feature_matrix = np.array([[-0.45844885, 0.38252113, -0.36960001, -0.13560773, 0.13533542, 0.23052562, 0.24497462, -0.36163417, 0.04772297, 0.48503474],
    #                            [-0.18996949, 0.34209557, -0.15796299, 0.00759797, -0.15692146, 0.34961173, 0.35143294, -0.18544715, 0.22263837, -0.09697504],
    #                            [-0.06577184, 0.15568463, -0.30410331, 0.11400567, 0.03151718, -0.08103861, -0.06509023, -0.4404048 , 0.23199243, -0.49147882],
    #                            [ 0.44428159, -0.10143358, -0.11483414, 0.19429417, 0.34130903, -0.16368089, 0.4915098 , 0.38444278, 0.44891271, 0.44136163],
    #                            [-0.08993319, -0.09229264, 0.22936645, 0.38360725, 0.08594918, -0.41670898, 0.05595383, 0.29091227, -0.01876491, -0.24964826]])
    # labels = np.array([-1,  1, -1,  1,  1])
    # T = 5
    # exp_res = (np.array([[0.3885997, -0.1424175, 1.1028841, 0.4496053, -0.7185204, 0.3331522, 0.7504839, 1.3386488, 0.0897194, -0.5276852]]), 1)
    # if check_tuple(
    #         ex_name, p1.perceptron,
    #         exp_res, feature_matrix, labels, T):
    #     return

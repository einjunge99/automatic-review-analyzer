...
T = 25
L = 0.0100
avg_peg_train_accuracy, avg_peg_test_accuracy = p1.classifier_accuracy(p1.pegasos, train_bow_features,test_bow_features,train_labels,test_labels,T=T,L=L)
print(avg_peg_test_accuracy)
#-------------------------------------------------------------------------------
...
print("Most explanatory word features for:")
print("positive classification below", sorted_word_features[:10])
print("negative classification below", sorted_word_features[-10:])